...
class GalleriesController extends AppController {
	...
	function edit($id = null) {
		if (!$id && empty($this->data)) {
			$this->Session->setFlash(__('Gallería inválida', true));
			$this->redirect(array('action' => 'index'));
		}
		if (!empty($this->data)) {
			if ($this->Gallery->save($this->data)) {
				$this->Session->setFlash(__('Galería modificada', true));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('La galería no pudo ser actualizada. Por favor, intente de nuevo.', true));
			}
		}
		if (empty($this->data)) {
	...
	function delete($id = null) {
		...
		if ($this->Gallery->delete($id)) {
			$this->Session->setFlash(__('Galería eliminada', true));
			$this->redirect(array('action'=>'index'));
		}
