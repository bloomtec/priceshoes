	 ...
	 <div id="producto-showcase">
	 	...
	 	<div class="caracteristicas">
			...
			<ul class="botones-caracteristicas">
				...
				<li>
				<a class='boton-facebook' href="javascript: void(0);" onclick="window.open('http://www.facebook.com/sharer.php?u=<?php echo urlencode($_SERVER['SERVER_NAME'])."/products/view/".$product["Product"]["id"];?>','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');">
