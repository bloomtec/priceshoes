...
<div id="crear-usuario">
	...
	<h2>Nuevos Clientes PriceShoes</h2>
		...
		<?php echo $form->create("usuario",array("action"=>"crear","controller"=>"users"));?>
			...
			<?php echo $form->input("email",array('div' => 'email forma-crear',"label"=>"Dirección E-mail"));?>
			<?php echo $form->input("email-repetir",array('div' => 'email forma-crear',"label"=>"Escriba de nuevo tu dirección E-mail"));?>
			<div style="clear:both"></div>
			</div>
			<div class="forma-linea">
			<?php echo $form->input("password",array('div' => 'password forma-crear',"label"=>"Contraseña"));?>
			<?php echo $form->input("password-repetir",array('div' => 'password forma-crear',"label"=>"Escribe de nuevo tu contraseña"));?>
			<div style="clear:both"></div>
			</div>
			<div class="forma-linea">
			<?php echo $form->input("nombres",array('div' => 'nombres forma-crear',"label"=>"Escribe tu (s) Nombre (s)"));?>
			<?php echo $form->input("apellidos",array('div' => 'nombre forma-crear',"label"=>"Escribe tu (s) Apellido (s)"));?>
			<div style="clear:both"></div>
			</div>
			<div class="forma-linea">
			<?php echo $form->input("pais",array('div' => 'residencia forma-crear',"label"=>"País de Residencia"));?>
			<?php echo $form->input("departamento",array('div' => 'residencia forma-crear',"label"=>"Departamento"));?>
			<div style="clear:both"></div>
			</div>
			<div class="forma-linea">
			<?php
    		$options=array('cedula'=>'Cédula','extranjera'=>'C/Extranjería','pasaporte'=>'Pasaporte');
    		$attributes=array('legend'=>'Identificación',);
    		echo $this->Form->radio('tipoId',$options,$attributes);?>
    		<div style="clear:both"></div>
    		</div>
			<div class="forma-linea">
			<?php echo $form->input("ciudad",array('div' => 'forma-crear',"label"=>"Ciudad de Residencia"));?>
			<div class="forma-crear calendario">
				<label>Fecha Nacimiento</label>
				<input class="date" type="date" min="1950-01-01" editable="true" name="data[usuario][fecha]">
				<div style="clear:both"></div>
			</div>
			<div style="clear:both"></div>
			</div>
			...
			<div style="clear:both"></div>
			<div class="forma-linea">
			<?php echo $form->input("direccion",array('div' => 'direccion forma-crear',"label"=>"Dirección/Estado"));?>
			<?php echo $form->input("apto",array('div' => 'apto forma-crear',"label"=>"Apto/Interior/Oficina"));?>
			<div style="clear:both"></div>
			</div>
			<div class="forma-linea">
