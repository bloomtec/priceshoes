			...
			switch($fileParts["extension"]){
				...
				<li> 
	 				...
	 				<div class="info">
						...
						<div class="actions">
							<div class="delete"  rel="<?php echo "/priceshoes".$folderPath."/".$fileName?>">borrar</div>
							<div class="seleccionar"  rel="<?php echo "/priceshoes".$folderPath."/".$fileName?>">seleccionar</div>
						</div>
					</div>
				</li>
				<?php	
