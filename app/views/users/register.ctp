	...
	<h2>Nuevos Clientes PriceShoes</h2>
		...
		<?php echo $form->create("User",array("action"=>"crear","controller"=>"users"));?>
			...
			<div class="email forma-crear">
				...
				<input id="UserFieldEmail-repetir" type="email" required="required" minlength="9" name="data[User][email-repetir]">
			</div>
			...
			<?php echo $form->input("password-repetir",array('type'=>'password','div' => 'password forma-crear',"label"=>"Escribe de nuevo tu contraseña",'required'=>'required','data-equals'=>"data[User][password]"));?>
			<div style="clear:both"></div>
			</div>
			<div class="forma-linea">
			...
			<div class="forma-linea">
			<?php echo $form->input("UserField.ciudad",array('div' => 'forma-crear',"label"=>"Ciudad de Residencia",'required'=>'required'));?>
			<div style="clear:both"></div>
			</div>
			<div style="clear:both"></div>
			<div class="forma-linea">
			<?php echo $form->input("UserField.direccion",array('div' => 'direccion forma-crear',"label"=>"Dirección/Estado",'required'=>'required'));?>
			<?php echo $form->input("UserField.direccion2",array('div' => 'apto forma-crear',"label"=>"Apto/Interior/Oficina",'required'=>'required'));?>
			<div style="clear:both"></div>
			</div>
			<div class="forma-linea">
